...
import org.seqcode.projects.chexalign.xlanalysis.CompositeModelComponent;
import org.seqcode.projects.chexalign.xlanalysis.TagProbabilityDensity;
...
public class CompositeModelMixtureMultiCond {
	...
	public CompositeModelMixtureMultiCond(CompositeTagDistribution tagDist, CompositeTagDistribution ctrlDist, GenomeConfig gcon, ExptConfig econ, XLAnalysisConfig ccon, ExperimentManager eMan){
		gconfig = gcon;
		econfig = econ;
		config = ccon;
		manager = eMan;
		...
		*/
		...
		if(controlCompositeDistrib==null){
			...
			for(ExperimentCondition cond : manager.getConditions()){
				...
				double[] ctmp = controlCompositeDistrib.getCompositeCrick(cond);
	...
	//		initBackDistrib = new TagProbabilityDensity(compositeDistrib.getWinSize());
			initBackDistrib = new TagProbabilityDensity(controlCompositeDistrib.getWinSize()-1);
			System.out.println("composite winsize "+compositeDistrib.getWinSize());
			System.out.println("control composite winsize "+controlCompositeDistrib.getWinSize());
			System.out.println("initBackDistrib.getWinSize() "+initBackDistrib.getWinSize());
			System.out.println("array length"+wcounts.length);
