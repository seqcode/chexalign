...
public class ProteinDNAInteractionModelMultiCond {
	 ...
	 * @param noisePi
	 */
	public ProteinDNAInteractionModelMultiCond(XLAnalysisConfig config, CompositeTagDistribution composite, TagProbabilityDensity initXLdistrib, TagProbabilityDensity initCSdistrib, 
	 ...
	 * @param XLComps
	 */
	public ProteinDNAInteractionModelMultiCond(XLAnalysisConfig config, int width, int centerOff, int numConds, double[][] compWatson, double[][] compCrick, List<CompositeModelComponent> CSComp, List<CompositeModelComponent> backComp, List<List<CompositeModelComponent>> XLComps){
		modelWidth = width;
