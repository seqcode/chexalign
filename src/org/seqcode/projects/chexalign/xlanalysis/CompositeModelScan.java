...
public class CompositeModelScan {
	...
	public CompositeModelScan(ProteinDNAInteractionModel model, int scanWindow, GenomeConfig gcon, ExptConfig econ, XLAnalysisConfig ccon, ExperimentManager eMan){
		gconfig = gcon;
		econfig = econ;
		config = ccon;
		manager = eMan;
