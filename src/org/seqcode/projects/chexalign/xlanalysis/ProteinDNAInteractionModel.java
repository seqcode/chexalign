...
public class ProteinDNAInteractionModel {
	 ...
	 * @param XLComps
	 */
	public ProteinDNAInteractionModel(XLAnalysisConfig config, int width, int centerOff, int numConds, double[][] compWatson, double[][] compCrick, CompositeModelComponent CSComp, CompositeModelComponent backComp, List<CompositeModelComponent> XLComps){
		modelWidth = width;
